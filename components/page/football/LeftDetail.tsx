      ...
      <div className="grid grid-cols-12 my-5">
        ...
        <div className="col-span-12 md:col-span-5 p-4 bg-gray-200">
          <h3 className="text-base md:text-xl font-bold hover:text-red">
            <Link href="#">
              AFC: Văn Toản thuộc top 8 cầu thủ đáng xem nhất vòng loại U23 châu Á
            </Link>
          </h3>
          <p className="text-sm my-1">
            Ngay trước thềm chiến dịch quan trọng của thầy trò ông Park, thủ thành của CLB Hải Phòng
            đã được Liên đoàn bóng đá châu Á (AFC) vinh danh.{' '}
          </p>
        ...
        <div key={item} className="grid grid-cols-12 pb-4 mb-4 border-b-1 border-gray">
          ...
          <div className="col-span-8 pl-3">
            <h4 className="text-base font-bold hover:text-red">
              <Link href="#">Ronaldo nói về việc chia tay ĐT Bồ Đào Nha để tận hiến cho MU</Link>
            </h4>
            <p className="hidden md:block text-sm mb-2">
              Ngay trước thềm chiến dịch quan trọng của thầy trò ông Park, thủ thành của CLB Hải
              Phòng đã được Liên đoàn bóng đá châu Á (AFC) vinh danh.{' '}
            </p>
            <p className="text-xs text-gray-400">2 giờ trước</p>
          </div>
        </div>
