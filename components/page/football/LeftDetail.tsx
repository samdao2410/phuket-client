  ...
  return (
    <div className='border-r-1 pr-4'>
      ...
      <div className="grid grid-cols-12 my-5">
        ...
        <div className="col-span-5 p-4 bg-gray-200">
          <h3 className='text-xl font-bold hover:text-red'>
      ...
      {
        data.map((item) => (
          <div className='grid grid-cols-12 pb-4 mb-4 border-b-1 border-gray'>
            ...
            <div className='col-span-8 pl-3'>
              ...
              <p className='text-sm mb-2'>Ngay trước thềm chiến dịch quan trọng của thầy trò ông Park, thủ thành của CLB Hải Phòng đã được Liên đoàn bóng đá châu Á (AFC) vinh danh. </p>
              <p className='text-xs'>2 giờ trước</p>
            </div>
